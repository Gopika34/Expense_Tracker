...
import { updateUsername, updatePassword } from "../api-services/profileServices";
import {
    notifyUsernameError,
    notifyPasswordUpdated,
    notifyPasswordError,
    notifyError,
    notifyUsernameUpdated   // ← make sure this exists in toastMessages.js
...
const Profile = () => {
    ...
    const handlePasswordUpdate = async () => {
        ...
        if (newPassword.length < 6) {
            notifyError("Password should contain at least 6 characters");
            return;
        }
        try {
